...
class ThreadRanker(object):
    ...
    def get_best_thread(self, question, tag_name):
        ...
        #compare = cosine_similarity(question_vec, thread_embeddings)[0]
        #sorted_index = np.argsort(-1*compare)
        #best_thread = thread_embeddings[sorted_index[0]]
...
class DialogueManager(object):
    ...
    def create_chitchat_bot(self):
        ...
        self.LeBoug = ChatBot('Bougzer')
        self.LeBoug.set_trainer(ChatterBotCorpusTrainer)
        self.LeBoug.train("chatterbot.corpus.english")
        #self.trainer = ChatterBotCorpusTrainer(self.LeBoug)
        #self.trainer.train("chatterbot.corpus.english")
        #self.LeBoug = ChatBot('Nim Obvious', trainer='chatterbot.trainers.ChatterBotCorpusTrainer')
    ...
    def generate_answer(self, question):
        ...
        if intent == 'dialogue':
            ...
            response = self.LeBoug.get_response(question)
            return response
